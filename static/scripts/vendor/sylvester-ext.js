define(["underscore","sylvester"], function (_, sylvester) {
    ...
    sylvester.Matrix.prototype.make3x3 = function()
    {
        ...
        return sylvester.Matrix.create([[this.elements[0][0], this.elements[0][1], this.elements[0][2]],
    ...
    // gluLookAt
    //
    sylvester.makeLookAt = function(ex, ey, ez,
                        cx, cy, cz,
                        ux, uy, uz)
    {
    ...
    // glOrtho
    //
    sylvester.makeOrtho = function(left, right,
                       bottom, top,
                       znear, zfar)
    {
    ...
    sylvester.makePerspective = function(fovy, aspect, znear, zfar)
    {
        ...
        return sylvester.makeFrustum(xmin, xmax, ymin, ymax, znear, zfar);
    };

    //
    // glFrustum
    //
    sylvester.makeFrustum = function(left, right,
                         bottom, top,
                         znear, zfar)
    {
